...
<!--            <li>-->
<!--                Номер карты: --><?php //= htmlspecialchars($payment['card_number']) ?><!--<br>-->
<!--                Срок действия: --><?php //= htmlspecialchars($payment['expiry_date']) ?><!--<br>-->
<!--                Имя держателя карты: --><?php //= htmlspecialchars($payment['cardholder_name']) ?><!--<br>-->
<!--            </li>-->
<!--        --><?php //endforeach; ?>
<!--    </ul>-->
